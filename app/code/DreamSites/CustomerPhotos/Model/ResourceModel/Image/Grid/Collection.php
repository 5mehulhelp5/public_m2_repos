<?php
/**
 * Grid Collection for Image
 */
namespace DreamSites\CustomerPhotos\Model\ResourceModel\Image\Grid;
...
class Collection extends ImageCollection implements SearchResultInterface
{
    /**
